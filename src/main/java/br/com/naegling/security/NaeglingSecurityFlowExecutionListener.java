...
public class NaeglingSecurityFlowExecutionListener extends SecurityFlowExecutionListener implements
	 ...
	 */
	private Collection<ConfigAttribute> buildWebExpressionConfigAttribute(Collection<ConfigAttribute> collection) {
